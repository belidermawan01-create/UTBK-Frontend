  ...
  return (
    <div className="admin-wrapper" style={{ padding: "2rem" }}>
      ...
      <p className="page-sub" style={{ marginBottom: "2rem" }}>
        Selamat datang di panel kontrol Admin UTBKPro.
      </p>
      ...
      <div className="mapel-grid">
        ...
        >
          <div className="mapel-name">
            <FileText size={20} /> Tambah / Edit Soal
          </div>
        ...
        >
          <div className="mapel-name">
            <TrendingUp size={20} /> Kelola Tryout
          </div>
          <div className="mapel-arrow" style={{ color: "var(--secondary)" }}>
            →
          </div>
        </Link>
        <div className="mapel-card" style={{ opacity: 0.5 }}>
          <div className="mapel-name">
            <Users size={20} /> Kelola Pengguna
          </div>
